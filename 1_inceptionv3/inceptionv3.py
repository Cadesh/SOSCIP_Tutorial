...
#model = InceptionV3(weights='imagenet', include_top=false) # to not use the last layer
...
while i < len(images):
    # load image
    img = image.load_img(images[i], target_size=(299, 299)) #299, 299
